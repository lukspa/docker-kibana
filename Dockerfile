...
RUN apk --update add bash curl wget && \
    ...
    /opt/kibana-${KIBANA_VERSION}-linux-x86_64/bin/kibana-plugin install "https://search.maven.org/remotecontent?filepath=com/floragunn/search-guard-kibana-plugin/6.5.4-17/search-guard-kibana-plugin-${KIBANA_VERSION}-17.zip" && \    
